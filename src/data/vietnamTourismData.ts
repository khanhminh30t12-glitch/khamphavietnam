    ...
    landmarks: [
      ...
      },
      {
        ...
        history: {
          ...
          en: 'The Paracel Islands are a coral archipelago in the East Sea, under the sacred and inseparable sovereignty of Vietnam, administered by Hoang Sa District, Da Nang City. Centuries ago under the Nguyen Dynasty, the Hoang Sa Flotilla was established to enforce sovereignty and guard national waters.'
        },
        architecture: {
          vi: 'Quần đảo bao gồm hơn 30 đảo, đá, cồn cát và rạn san hô nhiệt đới rực rỡ. Nổi bật với Mốc Chủ Quyền thiêng liêng, hệ sinh thái san hô và biển sâu vô cùng phong phú.',
          en: 'Comprising over 30 islands, reefs, sandbars, and vibrant tropical coral reefs. Highlighted by sacred national sovereignty markers and rich marine ecosystems.'
        },
        cuisine: {
          vi: 'Hải sản biển sâu như ốc xà cừ, cá ngừ đại dương, hải sâm và đặc sản rong biển tươi xứ đảo.',
          en: 'Deep-sea seafood including turban snails, oceanic tuna, sea cucumbers, and island seaweed.'
        },
        nearbyFood: ['res_mi_quang'],
        nearbyHotels: ['hot_inter_dn'],
        nearbyCafes: ['cafe_muto_dn'],
        checkInReward: 300,
        badge: 'badge_sovereignty',
        isIsland: true
      },
      {
        id: 'lm_truong_sa',
        ...
        history: {
          ...
          en: 'The Spratly Islands form a sacred maritime territory of Vietnam, belonging to Truong Sa Island District, Khanh Hoa Province. They serve as an enduring symbol of resilience protecting national maritime sovereignty.'
        },
        architecture: {
          vi: 'Cột mốc chủ quyền Cột cờ Tổ quốc kiên cường giữa biển khơi, Nhà giàn DK1, công viên Cây Bàng Vuông, Cây Phong Ba và các ngôi chùa Việt rợp bóng cờ đỏ sao vàng.',
          en: 'Sacred sovereignty markers, national flagpoles, DK1 offshore rigs, Square Banyan trees, Phong Ba trees, and traditional Vietnamese pagodas adorned with national flags.'
        },
        cuisine: {
          vi: 'Đặc sản chà bông cá ngừ đại dương, rau mầm tươi trồng trên đảo, cá mú đỏ biển sâu và trà sâm biển Trường Sa.',
          en: 'Oceanic tuna floss, fresh island sprouts, red coral grouper, and Truong Sa sea ginseng tea.'
        },
        nearbyFood: ['res_mi_quang'],
        nearbyHotels: ['hot_four_seasons'],
        nearbyCafes: ['cafe_faifo_ha'],
