...
export default function AppOnboardingTour({ isOpen, onClose }: AppOnboardingTourProps) {
  ...
  return (
    <>
      {/* SPOTLIGHT OVERLAY EFFECT FOCUSING TARGET UI FOR STEPS 2, 3, 4 */}
      <SpotlightOverlay currentStep={currentStep} isVisible={isOpen} />

      {/* ONBOARDING MODAL DIALOG CARD */}
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-auto">
        ...
        <div className="relative w-full max-w-lg bg-[#FDFBF7] border-4 border-red-600 rounded-3xl p-6 md:p-8 shadow-2xl shadow-red-950/80 text-slate-900 overflow-hidden [transform:translate3d(0,0,0)] [will-change:transform]">
          {/* HEADER BAR */}
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 mb-6">
            ...
            <div className="relative w-20 h-24 flex-shrink-0 flex items-center justify-center">
              ...
              <svg viewBox="0 0 100 120" className="w-full h-full drop-shadow-xl relative z-10 animate-bounce">
                <defs>
                  <linearGradient id="starHeadGradSpot" x1="0%" y1="0%" x2="100%" y2="100%">
                ...
                <polygon points="50,5 61,28 85,30 67,46 72,70 50,57 28,70 33,46 15,30 39,28" fill="url(#starHeadGradSpot)" stroke="#7f1d1d" strokeWidth="2" />
